...
// custom macros for levi
enum { MACRO_VERSION_INFO,
       VS_BACK_1,
       VS_FORWARD_2,
       VS_GOTO_IMPLEMENTATION_3,
...
KEYMAPS(
 [PRIMARY] = KEYMAP_STACKED
  (___,             Key_1,         Key_2,     Key_3,      Key_4, Key_5, Key_LEDEffectNext,
   ...
   M(MACRO_VERSION_INFO),   Key_6, Key_7, Key_8, Key_9, Key_0, LockLayer(NUMPAD),
  ...
  (___,      Key_F1,           Key_F2,      Key_F3,     Key_F4,        Key_F5,           Key_CapsLock,
   ...
   Key_Home, Key_mouseL,       M(VS_BACK_1), M(VS_GOTO_IMPLEMENTATION_3), M(VS_FORWARD_2), Key_mouseWarpNW,
...
const macro_t *macroAction(uint8_t macroIndex, uint8_t keyState) {
  ...
  case VS_BACK_1:
    ...
    return MACRODOWN(I(25),
                     D(LeftControl), T(Minus), U(LeftControl));
                     
  case VS_FORWARD_2:
    // ctrl + Shift -
    return MACRODOWN(I(25),
                     D(LeftControl), D(LeftShift), T(Minus), U(LeftControl), U(LeftShift));
  case VS_GOTO_IMPLEMENTATION_3:
    // ctrl + Shift -
    return MACRODOWN(I(25),
                     D(LeftControl), T(F12), U(LeftControl));
    break;
  }
  return MACRO_NONE;
}
